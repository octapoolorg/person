...
<section class="my-8 mb-10 px-6 py-10 shadow rounded-lg border">
    <div class="flex flex-wrap md:justify-start gap-2 sm:gap-4">
        <!-- Twitter -->
        <a href="https://twitter.com/intent/tweet?text={!! request()->url() !!}"
           class="px-3 py-2 sm:px-4 sm:py-2 bg-slate-900 text-white rounded-full hover:bg-slate-950 flex items-center gap-2 transition-colors duration-300"
        ...
        <a href="mailto:?subject={!! $data['nameDetails']->name !!} name details - all you need to know&amp;body={!! request()->url() !!}"
           class="px-3 py-2 sm:px-4 sm:py-2 bg-slate-500 text-white rounded-full hover:bg-slate-600 flex items-center gap-2 transition-colors duration-300"
