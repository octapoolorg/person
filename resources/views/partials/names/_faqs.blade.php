<!-- FAQ Section -->
<section class="px-6 py-10 mb-10 rounded-lg shadow border" itemscope itemtype="https://schema.org/FAQPage">
    <h2 class="text-2xl md:text-4xl text-slate-800 mb-4 md:mb-10 font-bold capitalize">
        Frequently Asked Questions about
        <span class="text-2xl leading-relaxed text-slate-700 max-w-prose">
            ({{ $data['nameDetails']->name }})
        </span>
    </h2>

    <div class="mx-auto space-y-6 divide-y divide-slate-200">

        @if(!empty($data['nameDetails']->meaning))
            <div itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
                <h3 itemprop="name" class="text-xl text-slate-800 font-bold py-4">
                    What is the meaning of {{ $data['nameDetails']->name }}?
                </h3>
                <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                    <p itemprop="text" class="text-lg leading-relaxed text-slate-700 max-w-prose">
