<aside class="w-full lg:w-1/3 md:px-4">
    <div class="shadow mb-6 p-6 rounded-lg border dark:border-slate-700">
        <h5 class="text-xl font-bold text-indigo-600 dark:text-indigo-400 mb-4">Generate Random Name</h5>
        <p class="text-slate-600 dark:text-slate-300 mb-6">Click to generate a list of random names to make a better choice.</p>
        <a href="{{ route('names.random') }}"
           class="inline-flex items-center justify-center bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-medium py-3 px-6 rounded-full hover:bg-gradient-to-l transition duration-300 ease-in-out uppercase text-sm lg:text-base">
            <svg class="fill-white mr-2" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 640 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M274.9 34.3c-28.1-28.1-73.7-28.1-101.8 0L34.3 173.1c-28.1 28.1-28.1 73.7 0 101.8L173.1 413.7c28.1 28.1 73.7 28.1 101.8 0L413.7 274.9c28.1-28.1 28.1-73.7 0-101.8L274.9 34.3zM200 224a24 24 0 1 1 48 0 24 24 0 1 1 -48 0zM96 200a24 24 0 1 1 0 48 24 24 0 1 1 0-48zM224 376a24 24 0 1 1 0-48 24 24 0 1 1 0 48zM352 200a24 24 0 1 1 0 48 24 24 0 1 1 0-48zM224 120a24 24 0 1 1 0-48 24 24 0 1 1 0 48zm96 328c0 35.3 28.7 64 64 64H576c35.3 0 64-28.7 64-64V256c0-35.3-28.7-64-64-64H461.7c11.6 36 3.1 77-25.4 105.5L320 413.8V448zM480 328a24 24 0 1 1 0 48 24 24 0 1 1 0-48z"/></svg>
            <span>Randomize</span>
        </a>
    </div>

    <div class="shadow my-6 p-6 rounded-lg  border dark:border-slate-700">
        <h5 class="text-xl font-bold text-indigo-600 dark:text-indigo-400 mb-4">Follow Us on Social</h5>
    ...
    <!-- Explore Baby Names -->
    <div class="shadow my-6 p-6 rounded-lg  border dark:border-slate-700">
        <h5 class="text-xl font-bold text-indigo-600 dark:text-indigo-400 mb-4">
            Explore Baby Names
        </h5>
