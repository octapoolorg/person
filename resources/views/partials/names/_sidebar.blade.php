<aside class="w-full lg:w-1/3 md:px-4">
    <div class="shadow mb-6 p-6 rounded-lg border">
        <h5 class="text-xl font-bold text-indigo-600 mb-4">Generate Random Name</h5>
        <p class="text-slate-600 mb-6">Click to generate a list of random names to make a better choice.</p>
    ...
    <div class="shadow my-6 p-6 rounded-lg  border">
