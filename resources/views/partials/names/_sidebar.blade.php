<aside class="w-full lg:w-1/3 px-4">
    <div class="bg-white dark:bg-gray-800 shadow-md mb-6 p-6 rounded-lg">
        ...
        <p class="text-gray-600 dark:text-gray-300 mb-6">Click to generate a list of random names to make a better choice.</p>
    ...
    <div class="bg-white dark:bg-gray-800 shadow-md my-6 p-6 rounded">
