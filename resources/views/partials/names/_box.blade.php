<div class="flex flex-col md:flex-row items-start md:items-center p-6 rounded-lg my-6 text-center md:text-start">
    ...
    <div class="flex-shrink-0 w-full md:w-32 mb-6 md:mb-0 mr-0 md:mr-12">
        ...
        <figcaption class="text-center font-semibold text-slate-800 mt-2">
            {{ $caption }}
        </figcaption>
    </div>
    ...
    <!-- Text Content -->
    <div class="flex-grow">
        <h3 class="text-2xl font-semibold mb-4 text-slate-900">{{ $title }}</h3>
        <p class="text-lg leading-relaxed text-slate-700 max-w-prose">{{ $description }}</p>
    </div>
</div>