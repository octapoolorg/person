<header class="flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 text-sm sm:py-0">
            ...
            <div class="flex w-full ms-auto sm:w-auto sm:mr-6">
                <form class="relative flex items-center w-full" action="{!! route('names.search') !!}">
                    ...
                    <input
                          ...
                          class="py-2 pl-4 pr-10 block w-full border border-slate-300 dark:border-slate-700 rounded-md shadow-sm bg-white dark:bg-slate-700 text-black dark:text-white placeholder-slate-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
