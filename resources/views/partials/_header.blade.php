            ...
            <div class="flex w-full ms-auto sm:w-auto sm:mr-6">
                <form class="relative flex items-center w-full" action="{!! route('names.search') !!}">
                    ...
                    <input
                          ...
                          class="py-2 pl-4 pr-10 block w-full border border-slate-300 dark:border-slate-700 rounded-md shadow-sm dark:bg-slate-800 text-black dark:text-white placeholder-slate-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 dark:focus:border-indigo-500"
