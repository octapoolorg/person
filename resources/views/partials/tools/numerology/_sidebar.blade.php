<aside class="w-full lg:w-1/3 px-4">
    <div class="bg-surface shadow-md mb-6 p-6 rounded-lg">
        <h5 class="text-xl font-bold text-primary-600 mb-4">Generate Random Name</h5>
        <p class="text-base-600 mb-6">Click to generate a list of random names to make a better choice.</p>
    ...
    <div class="bg-surface shadow-md my-6 p-6 rounded">
        <h5 class="text-xl font-bold text-primary-600 mb-4">Follow Us on Social</h5>
