    ...
    <section class="flex flex-col lg:flex-row mb-12">
        <main class="w-full lg:w-2/3 px-4 mb-4 lg:mb-0">
            ...
            <section class="bg-gray-100 p-8 md:p-16 rounded shadow overflow-hidden relative text-gray-900 border">
                ...
                <footer
                    class="absolute bottom-0 left-0 w-full bg-blue-700 text-gray-100 text-center py-6 border-t border-blue-800">
            ...
            <section class="bg-gray-100 p-8 rounded shadow mb-10 border">
                <h2 class="text-3xl text-gray-800 mb-6">Details about {!! $data['nameDetails']->name !!} name</h2>

                <div class="my-6">
                    <h3 class="text-2xl text-gray-800 mb-4">{!! $data['nameDetails']->name !!} Name Numerology</h3>
                ...
                <div class="flex flex-wrap -mx-4">
                    ...
                    <div class="w-full md:w-1/3 px-4 mb-8 flex flex-col justify-between">
                        <div class="flex items-start mb-4">
                            <img src="https://static-00.iconduck.com/assets.00/destiny-icon-512x475-qi0g8ih3.png"
                                 alt="Destiny Icon" class="w-12 h-12 mr-4">
        ...
        <div class="flex items-center">
            ...
            <section class="text-gray-900">
                <h2 class="text-3xl text-gray-700 my-6">{!! $data['nameDetails']->name !!} Name Wallpaper</h2>
                <img src="{!! route('nameWallpaper',['name'=>$data['nameDetails']->slug]) !!}"
                     class="rounded-lg my-8 shadow-lg w-full object-cover md:h-96"
                     alt="{!! $data['nameDetails']->name !!}">
                <p class="my-8">Discover the unique charm of the {!! $data['nameDetails']->name !!} name wallpaper.
                    Every curve and detail of the design captures the essence of the name, making it a perfect backdrop
                    for your devices. Elevate your screens with this blend of artistry and elegance.</p>
            </section>

            <!-- Fancy Text Styles section -->
            <section class="text-gray-800">
                <h2 class="text-3xl text-gray-700 my-6">{{ $data['nameDetails']->name }} - Fancy Text Styles</h2>
                <p class="my-4 sm:my-8 text-left">Experience the elegance of {{ $data['nameDetails']->name }} presented in
                    various distinctive text styles. Each style is crafted to highlight the uniqueness of the name,
                    adding a touch of sophistication and charm to your content.</p>
                    ...
                    <div class="border border-gray-300 rounded shadow mb-12">
                        <table class="min-w-full divide-y divide-gray-200 cursor-pointer bg-white hover:shadow-sm" id="fancyTextTable">
                            ...
                            @foreach ($data['fancyTexts'] as $key => $fancyText)
                                <!-- Using 'td' instead of 'th' since these are not headers -->
                                <tr tabindex="0" class="fancy-text">
                                    <td
                                        class="text-lg p-4 text-left border hover:bg-gray-200 transition ease-in-out duration-150">
                                        {{ $fancyText }}
                                    </td>
                                </tr>
                            @endforeach
            ...
            <section class="my-8">
                <div class="flex flex-wrap justify-center md:justify-start gap-2 sm:gap-4">
                    ...
                    <a href="https://twitter.com/intent/tweet?text=url-current-page"
                       class="px-3 py-2 sm:px-4 sm:py-2 bg-gray-900 text-white rounded-full hover:bg-gray-700"
                ...
                <div class="space-y-6 max-w-4xl mx-auto"> <!-- Centered with max width for large screens -->
                    <article class="flex space-x-4 p-4 bg-white rounded-xl shadow-md">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-gray-600">This is a comment about the post. It's a sample text to show how
                                the comment will look.
                            </p>
                        </div>
                    </article>
                </div>
        ...
        <aside class="w-full lg:w-1/3 px-4">
            <div class="bg-white shadow-md my-6 p-6 rounded">
                ...
                <a href="{!! route('getRandomNames') !!}"
                   class="bg-gradient-to-r from-blue-500 to-blue-600 text-white py-3 px-6 rounded-full inline-flex items-center hover:from-blue-600 hover:to-blue-700 transition duration-200 ease-in uppercase">
