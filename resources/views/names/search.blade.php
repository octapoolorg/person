...
<section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
    <div class="py-12 mt-8 md:mt-20 bg-surface dark:bg-base-800 rounded-lg shadow px-5">
            ...
            <div class="flex flex-col md:flex-row gap-6 mb-8">
                <div class="relative flex-grow">
                    <input
                        ...
                        class="w-full pl-12 pr-4 py-3 border border-base-300 text-base-700 rounded-md shadow-sm focus:ring-primary-500 focus:border-primary-500 transition duration-300 ease-in-out placeholder-base-400"
        ...
        <div id="search-results">
            @forelse ($names as $name)
                <div class="mb-6 p-4 bg-surface dark:bg-base-700 border border-base-200 dark:border-base-600 rounded-lg transition-shadow duration-300 ease-in-out hover:shadow-lg">
                    <a href="{!! route('names.show', $name) !!}" class="flex justify-between items-center text-base-800 dark:text-base-200 hover:text-primary-600 dark:hover:text-primary-400">
                        ...
                        <span class="text-primary-600 hover:text-primary-800 dark:hover:text-primary-500 transition duration-300 ease-in-out">Learn more &rarr;</span>
                    </a>
                </div>
            @empty
