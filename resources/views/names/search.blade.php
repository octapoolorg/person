            ...
            <form action="{{ route('names.search') }}" method="GET" class="mt-12">
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
                    <div class="lg:col-span-8">
                        <div class="relative">
                            ...
                            <input type="search" name="q" id="search" class="w-full pl-14 pr-4 py-3 bg-base-50 dark:bg-base-800 border border-base-300 dark:border-base-500 text-base-700 dark:text-base-300 rounded-lg transition duration-300 ease-in-out focus:bg-surface focus:border-primary-500 focus:ring-0" placeholder="Search..." value="{{ request()->query('q') }}">
                        </div>
                    </div>
                ...
                <div class="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-6">
                    <div class="sm:col-span-1">
                        ...
                        <select id="alphabet" name="alphabet" class="mt-1 block w-full pl-3 pr-10 py-2 bg-base-50 dark:bg-base-800 dark:text-base-300 border border-base-300 dark:border-base-500 text-base-700 rounded-lg shadow-sm focus:bg-surface focus:border-primary-500 focus:ring-0 transition duration-300 ease-in-out">
                    ...
                    <div class="sm:col-span-1">
                        ...
                        <select id="origin" name="origin" class="mt-1 block w-full pl-3 pr-10 py-2 bg-base-50 dark:bg-base-800 dark:text-base-300 border border-base-300 dark:border-base-500 text-base-700 rounded-lg shadow-sm focus:bg-surface focus:border-primary-500 focus:ring-0 transition duration-300 ease-in-out">
                    ...
                    <div class="sm:col-span-1">
                        ...
                        <select id="gender" name="gender" class="mt-1 block w-full pl-3 pr-10 py-2 bg-base-50 dark:bg-base-800 dark:text-base-300 border border-base-300 dark:border-base-500 text-base-700 rounded-lg shadow-sm focus:bg-surface focus:border-primary-500 focus:ring-0 transition duration-300 ease-in-out">
