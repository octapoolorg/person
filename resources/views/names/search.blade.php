        ...
        <main class="w-full lg:w-2/3 px-4 mb-4 lg:mb-0">
                ...
                <form action="{!! route('names.search') !!}" method="GET">
                    ...
                    <div class="relative">
                        <input type="search" id="search" name="q"
                               class="w-full pl-10 pr-4 py-3 border border-slate-300 dark:border-slate-700 rounded-full shadow-sm focus:outline-none focus:border-indigo-500 dark:focus:border-indigo-400 focus:ring-1 focus:ring-indigo-500 dark:focus:ring-indigo-400 transition duration-300 ease-in-out dark:bg-slate-800 dark:text-slate-100"
            ...
            <div id="search-results" class="space-y-4">
                @forelse ($names as $name)
                    <a href="{!! route('names.show', $name) !!}" class="p-4 bg-white dark:bg-slate-800 shadow dark:shadow-none rounded-lg flex justify-start items-center hover:bg-slate-50 dark:hover:bg-slate-700 transition duration-300 ease-in-out">
                        <div class="flex-grow">
