        ...
        <main class="w-full lg:w-2/3 px-4 mb-4 lg:mb-0">
            ...
            <section class="bg-gray-100 p-8 md:p-16 rounded-lg shadow-lg overflow-hidden relative text-gray-900 border">
                <article class="text-center">
                    <!-- Name -->
                    <header>
                        <h1 class="text-4xl md:text-7xl font-bold mb-6 md:mb-12 tracking-tight" id="actual-name">
            ...
            <section class="bg-white p-10 rounded-lg shadow mb-10 border">
                <div class="flex flex-col md:flex-row justify-between items-center relative">
                    <h2 class="text-2xl md:text-4xl text-gray-800 mb-4 md:mb-10 font-bold relative">
            ...
            <section class="bg-white py-8 px-4 md:px-8 rounded-lg shadow my-10">
                <div class="flex flex-col md:flex-row items-center justify-between mb-6">
                    ...
                    <a href="javascript:" id="generate-abbreviations" class="mt-4 md:mt-0 text-indigo-600 hover:text-indigo-800 font-semibold transition-colors duration-300 flex items-center">
                        Generate another
                ...
                <div class="overflow-hidden">
                    <table class="w-full text-left text-gray-600">
                        <tbody class="divide-y divide-gray-200" id="abbreviations">
...
{{--                </div>--}}
            ...
            <section class="px-6 py-10 mb-10 text-gray-800 rounded-lg shadow border-t border-gray-100">
