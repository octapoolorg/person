        ...
        <main class="w-full lg:w-2/3 px-4 mb-4 lg:mb-0">
            <div id="search-results" class="space-y-4">
                @forelse ($names as $name)
                    <a href="{!! route('names.show', $name) !!}" class="p-4 bg-white dark:bg-slate-800 shadow dark:shadow-none rounded-lg flex justify-start items-center hover:bg-slate-50 dark:hover:bg-slate-900 transition duration-300 ease-in-out">
                        <div class="flex-grow">
