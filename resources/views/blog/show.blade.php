    ...
    <section class="max-w-7xl mx-auto px-6 md:px-4 lg:px-8">
        ...
        <aside class="w-full lg:w-1/3 md:px-4">
            <div class="lg:sticky relative top-8">
                <section class="mb-8 overflow-hidden shadow rounded-lg p-6">
                    <h2 class="text-2xl font-bold text-slate-800 mb-6">About the Author</h2>
                ...
                <section class="overflow-hidden shadow rounded-lg p-6">
                    <h2 class="text-2xl font-bold text-slate-800 mb-6">Related Posts</h2>
