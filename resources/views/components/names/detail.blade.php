    ...
    <article class="text-center">
        <header x-data>
            <h1 class="text-4xl sm:text-5xl font-bold mb-4 dark:text-base-100">
                ...
                {{ $name->name }}
                <a href="javascript:;" @click.prevent="SpeechManager.speak($refs.name.value.trim())" class="text-lg text-green-500 dark:text-green-400 hover:text-green-600 dark:hover:text-green-500">
        ...
        <div class="mt-8 mb-12">
            ...
            @foreach ($name->meanings as $key => $meaning)
                @if ($meaning)
