<aside class="w-full lg:w-1/3 md:px-4 space-y-8">
    <!-- Explore Baby Names -->
    <div class="shadow mb-6 p-6 rounded-lg bg-surface dark:bg-base-800 border border-gray-200 dark:border-gray-700 transition-all hover:shadow-lg">
    ...
    <!-- Trending Names -->
    <div class="shadow p-6 rounded-lg bg-surface dark:bg-base-800 border border-gray-200 dark:border-gray-700 transition-all hover:shadow-lg">
        ...
        <ul class="list-none pl-0 text-base-600 dark:text-base-300">
            @foreach($namesList->random(5) as $name)
                <li class="mb-4">
