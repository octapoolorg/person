<!-- FAQ Section -->
<section class="px-6 py-10 mb-10 rounded-lg shadow dark:shadow-none border dark:border-base-700 bg-surface dark:bg-base-800" id="questions" itemscope itemtype="https://schema.org/FAQPage">
    ...
    <div class="mx-auto space-y-6 divide-y divide-base-200 dark:divide-base-700">
        ...
        <div itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
            ...
            <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                <p itemprop="text" class="text-lg leading-relaxed text-base-700 dark:text-base-300 max-w-prose">
                    In numerology, {!! $name->name !!} has a destiny number of {!! $name->numerology['numbers']['destiny'] !!},
                    reflecting {!! trans('numerology.traits.destiny.' . $name->numerology['numbers']['destiny']) !!}.
                    The soul urge number is {!! $name->numerology['numbers']['soul_urge'] !!},
                    indicating {!! trans('numerology.traits.soul_urge.' . $name->numerology['numbers']['soul_urge']) !!},
                    and the personality number is {!! $name->numerology['numbers']['personality'] !!},
                    suggesting {!! trans('numerology.traits.personality.' . $name->numerology['numbers']['personality']) !!}.
                </p>
            </div>
        </div>
    </div>
