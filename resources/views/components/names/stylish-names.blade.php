<section id="stylish-names"
    ...
    <div class="flex flex-col md:flex-row items-end md:items-center justify-end my-6">
    ...
    <div class="overflow-x-auto" x-data>
        <ul class="divide-y divide-base-200 dark:divide-base-700 overflow-x-auto" id="fancy-texts">
            @foreach ($name->fancyTexts as $fancyText)
                <li
                    class="text-lg p-4 hover:bg-base-100 dark:hover:bg-base-700 transition ease-in-out duration-150 cursor-pointer copy-to-clipboard text-base-900 dark:text-base-100 whitespace-nowrap select-text"
