                ...
                @foreach ($data['popularNames'] as $name)
                    <a href="{!! route('names.show', $name->slug) !!}" class="group rounded-lg overflow-hidden shadow-md hover:shadow-lg border border-base-200 dark:border-base-700 transition-all duration-300 ease-in-out">
                        <div class="p-8 text-center">
                            ...
                            <p class="text-base-600 dark:text-base-300 mt-3 text-sm">{{ $name->meaning }}</p>
                            <span class="text-primary-600 hover:text-primary-800 dark:text-primary-400 dark:hover:text-primary-200 text-sm font-semibold tracking-wide mt-4 inline-block transition-colors duration-300">Learn more</span>
                        </div>
                    </a>
                @endforeach
            </div>
